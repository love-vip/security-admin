package com.vip.admin.oauth2.support.security.base;

import cn.hutool.extra.spring.SpringUtil;
import com.vip.admin.oauth2.support.security.core.exception.BadAccessTokenException;
import com.vip.admin.oauth2.support.security.core.exception.BadCaptchaException;
import com.vip.admin.oauth2.support.security.core.principal.Oauth2User;
import com.vip.admin.oauth2.support.security.util.OAuth2ErrorCodesExpand;
...
import static com.vip.admin.oauth2.support.security.util.OAuth2AuthenticationProviderUtils.getAuthenticatedClientElseThrowInvalidClient;
...
public abstract class OAuth2BaseAuthenticationProvider<T extends OAuth2BaseAuthenticationToken> implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        /*
         * @see com.vip.admin.commons.security.converter.OAuth2BaseAuthenticationConverter#convert(HttpServletRequest)
         */
        ...
        try {
             ...
             * @see com.vip.admin.oauth2.support.security.customizer.core.CustomeOAuth2JwtTokenCustomizer#customize(JwtEncodingContext)
